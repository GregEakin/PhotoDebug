...
public class UnitTests
{
    ...
    public void ReadFile()
    {
        ...
        Assert.True(startOfImage.ImageData.EndOfFile);
        Assert.Equal(startOfImage.ImageData.RawData.Length, startOfImage.ImageData.Index + 1);
        Assert.Equal(7, startOfImage.ImageData.BitsLeft);
    }
    ...
    private static void DumpBitmap(string fileName2, string bitmap)
    {
        ...
        //Assert.Equal(x * y + z, startOfFrame.Width); // Sensor width (bits)
        //Assert.Equal(x * y + z, startOfFrame.SamplesPerLine * startOfFrame.Components.Length);
