...
public class CM5Ifd0
{
    ...
    public CM5Ifd0(ITestOutputHelper testOutputHelper)
    {
    ...
    public void TagsInDirectory()
    {
        ...
        Assert.Equal(
            new ushort[] { 0x0100, 0x0101, 0x0102, 0x0103, 0x010E, 0x010F, 0x0110, 0x0111, 0x0112, 0x0117, 0x011A, 0x011B, 0x0128, 0x0132, 0x013B, 0x02BC, 0x8298, 0x8769, 0x8825 },
    ...
    {
        var d = new DirectoryInfo(@"\\Data\Photo\2017\2017-11-21");
