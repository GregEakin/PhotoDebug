...
public class CM5Ifd3
{
    ...
    public void StripOffset()
    {
        ...
        Assert.Equal(8104448u, imageFileEntry.ValuePointer);
        Assert.Equal(1u, imageFileEntry.NumberOfValue);
    }
    ...
    public void StripByteCounts()
    {
        ...
        Assert.Equal(29690604u, imageFileEntry.ValuePointer);
        Assert.Equal(1u, imageFileEntry.NumberOfValue);
    }
    ...
    public void Cr2Slice()
    {
        ...
        Assert.Equal(3, imageFileEntry.TagType);
        Assert.Equal(0x0000B566u, imageFileEntry.ValuePointer);
        Assert.Equal(3u, imageFileEntry.NumberOfValue);

        Assert.Equal(new[] { (ushort)0, (ushort)0, (ushort)6288 },
