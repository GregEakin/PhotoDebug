...
namespace PhotoTests.Prototypes
{
    ...
    public class GpsData2
    {
        ...
        private static void DumpGpsInfo(BinaryReader binaryReader, uint offset)
        {
            ...
            var localTime = ConvertDateTime(date, time1, time2, time3);
        ...
        public static DateTime ConvertDateTime(string date, double time1, double time2, double time3)
        {
            ...
            var dateTime = new DateTime(year, month, day, (int)time1, (int)time2, (int)time3, DateTimeKind.Utc);
            dateTime = dateTime.AddMilliseconds((time3 - (int)time3) * 1000.0);
