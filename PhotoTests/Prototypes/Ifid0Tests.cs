...
public class Ifid0Tests
{
    ...
    private static void DumpImage0(string fileName)
    {
        ...
        var imageLength = image.Entries.Single(e => e.TagId == 0x0101 && e.TagType == ImageFileEntry.TagTypes.UShort).ValuePointer;
        ...
        var imageFileEntry010F = image.Entries.Single(e => e.TagId == 0x010F && e.TagType == ImageFileEntry.TagTypes.Ascii);
        ...
        var imageFileEntry0110 = image.Entries.Single(e => e.TagId == 0x0110 && e.TagType == ImageFileEntry.TagTypes.Ascii);
        ...
        var imageFileEntry011A = image.Entries.Single(e => e.TagId == 0x011A && e.TagType == ImageFileEntry.TagTypes.URational);
        ...
        var imageFileEntry011B = image.Entries.Single(e => e.TagId == 0x011B && e.TagType == ImageFileEntry.TagTypes.URational);
        ...
        var resolutionUnit = image.Entries.Single(e => e.TagId == 0x0128 && e.TagType == ImageFileEntry.TagTypes.UShort).ValuePointer;
        Assert.Equal(2u, resolutionUnit); // 1 == none, 2 == pixels per inch, 3 == pixels per centimeter

        var imageFileEntry0132 = image.Entries.Single(e => e.TagId == 0x0132 && e.TagType == ImageFileEntry.TagTypes.Ascii);
        ...
        var imageFileEntry013B = image.Entries.Single(e => e.TagId == 0x013B && e.TagType == ImageFileEntry.TagTypes.Ascii);
        ...
        var imageFileEntry8298 = image.Entries.Single(e => e.TagId == 0x8298 && e.TagType == ImageFileEntry.TagTypes.Ascii);
        ...
        var exif = image.Entries.Single(e => e.TagId == 0x8769 && e.TagType == ImageFileEntry.TagTypes.ULong).ValuePointer;
