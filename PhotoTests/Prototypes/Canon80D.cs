...
namespace PhotoTests.Prototypes
{
    ...
    public class Canon80D
    {
        ...
        private static void DumpImage3Raw(string fileName)
        {
            ...
            Assert.Equal(4056u, startOfFrame.ScanLines); 
            Assert.Equal(3144u, startOfFrame.SamplesPerLine); 
            Assert.Equal(6288, startOfFrame.Width); 
