...
public class UnitTest5D1
{
    ...
    public void RawImageSize()
    {
        ...
        Assert.Equal(12, lossless.Precision);
        Assert.Equal(2, lossless.Components.Length);
        Assert.Equal(2238, lossless.SamplesPerLine);
        Assert.Equal(2954, lossless.ScanLines);
    }
    ...
    public void Bits()
    {
        ...
        Assert.Equal(12, lossless.Precision - (startOfScan.Bb3 & 0x0f));
    }
    ...
    public void TestMethod6()
    {
        ...
        Assert.Equal(4476, lossless.Width); // Sensor width (bits)
        Assert.Equal(4476, lossless.SamplesPerLine * lossless.Components.Length);
        Assert.Equal(4476, x * y + z);
    ...
    public void Test2()
    {
        ...
        Assert.Equal(0x00015634u, address);
        Assert.Equal(0x0019351Eu, length);
