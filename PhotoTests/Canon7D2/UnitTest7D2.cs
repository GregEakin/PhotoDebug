...
public class UnitTest7D2
{
    ...
    public void RawImageSize()
    {
        ...
        Assert.Equal(2784, lossless.SamplesPerLine);
        Assert.Equal(3708, lossless.ScanLines);
    }
    ...
    public void TestMethod6()
    {
        ...
        Assert.Equal(5568, lossless.Width); // Sensor width (bits)
        Assert.Equal(5568, lossless.SamplesPerLine * lossless.Components.Length);
        Assert.Equal(5568, x * y + z);
