...
public class C5D2Ifd1
{
    ...
    public void TagsInDirectory()
    {
        ...
        Assert.Equal(new ushort[] { 0x0201, 0x0202 }, imageFileDirectory.Entries.Select(e => e.TagId).ToArray());
    }
}
