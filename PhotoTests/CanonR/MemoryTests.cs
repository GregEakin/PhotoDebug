    ...
    public class MemoryTests
    {
        ...
        public void MemoryMappedFilesStreamTest()
        {
...

            {
                ...
                Assert.Equal("ftyp", fileTypeBox.Type);

                Assert.Equal("crx ", fileTypeBox.MajorBrand);
                Assert.Equal(1, fileTypeBox.Version);

                Assert.Equal(new[] { "crx ", "isom" }, fileTypeBox.CompatibleBrands);
            }
        }
    }
}