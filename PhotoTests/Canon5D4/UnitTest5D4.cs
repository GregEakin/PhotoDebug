...
{
    private const string FileName = @"\\Data\Photo\Canon 5D IV\Y_DReggie_03.CR2";
    ...
    public void RawImageSize()
    {
        ...
        Assert.Equal(3440, lossless.SamplesPerLine);
        Assert.Equal(2272, lossless.ScanLines);
    }
    ...
    public void TestMethod6()
    {
        ...
        Assert.Equal(13760, lossless.Width); // Sensor width (bits)
        Assert.Equal(13760, lossless.SamplesPerLine * lossless.Components.Length);
        Assert.Equal(6880, x * y + z);
    ...
    public void Test2()
    {
        ...
        Assert.Equal(0x00010268u, address);
        Assert.Equal(0x001AC95Du, length);
        Assert.Equal(8u, orientation);
