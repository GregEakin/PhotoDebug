    ...
    public class C5D4Ifd1
    {
        ...
        public void ImageWidth()
        {
            ...
            using (var binaryReader = new BinaryReader(fileStream))
            {
                ...
                Assert.AreEqual(6720u, imageFileEntry.ValuePointer);
        ...
        public void ImageLength()
        {
            ...
            using (var binaryReader = new BinaryReader(fileStream))
            {
                ...
                Assert.AreEqual(3, imageFileEntry.TagType);
                Assert.AreEqual(4480u, imageFileEntry.ValuePointer);
                Assert.AreEqual(1u, imageFileEntry.NumberOfValue);
            }
        }
        ...
        public void Model()
        {
            ...
            using (var binaryReader = new BinaryReader(fileStream))
            {
                ...
                Assert.AreEqual(21u, imageFileEntry.NumberOfValue);

                Assert.AreEqual("Canon EOS 5D Mark IV", RawImage.ReadChars(binaryReader, imageFileEntry));
            }
        }
        ...
        public void XmpMetadata()
        {
            ...
            using (var binaryReader = new BinaryReader(fileStream))
            {
                ...
                Assert.AreEqual(0x0000B608u, imageFileEntry.ValuePointer);
