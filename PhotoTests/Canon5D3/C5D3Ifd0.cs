...
public class C5D3Ifd0
{
    ...
    private const string FileName = @"\\Data\Photo\2019\2019-08-18\0L2A4564.CR2";
    private readonly ITestOutputHelper _testOutputHelper;

    public C5D3Ifd0(ITestOutputHelper testOutputHelper)
    {
    ...
    public void ImageWidth()
    {
        ...
        Assert.Equal(5760u, imageFileEntry.ValuePointer);
    ...
    public void ImageLength()
    {
        ...
        Assert.Equal(3, imageFileEntry.TagType);
        Assert.Equal(3840u, imageFileEntry.ValuePointer);
        Assert.Equal(1u, imageFileEntry.NumberOfValue);
    }
    ...
    public void Model()
    {
        ...
        Assert.Equal(22u, imageFileEntry.NumberOfValue);

        Assert.Equal("Canon EOS 5D Mark III", RawImage.ReadChars(binaryReader, imageFileEntry));
    }
    ...
    public void ShutterSpeedValue()
    {
        ...
        Assert.Equal(1.0/331.99092599065848782839501985066, value);
    ...
    public void Aperture()
    {
        ...
        Assert.Equal(4 * Math.Sqrt(2.0), value);
    ...
    public void XmpMetadata()
    {
        ...
        Assert.Equal(0x000119C4u, imageFileEntry.ValuePointer);
