...
namespace PhotoTests.Canon5D3
{
    ...
    public class UnitTest5D3
    {
        ...
        public void RawImageSize()
        {
            ...
            Assert.Equal(2960, lossless.SamplesPerLine);
            Assert.Equal(3950, lossless.ScanLines);
        }
        ...
        public void TestMethod6()
        {
            ...
            Assert.Equal(5920, lossless.Width); // Sensor width (bits)
            Assert.Equal(5920, lossless.SamplesPerLine * lossless.Components.Length);
            Assert.Equal(5920, x * y + z);
        ...
        public void Test2()
        {
            ...
            Assert.Equal(0x00016F80u, address);
            Assert.Equal(0x00292F71u, length);
