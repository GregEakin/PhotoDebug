...
namespace FJCore.Decoder
{
    internal class JpegQuantizationTable
    {
        ...
        /// </summary>
        public static readonly JpegQuantizationTable K1Luminance = new JpegQuantizationTable(new int[]
        {
        ...
        /// </summary>
        public static readonly JpegQuantizationTable K1Div2Luminance =
        ...
        /// stored in natural order.
        /// </summary>
        public static readonly JpegQuantizationTable K2Chrominance = new JpegQuantizationTable(new int[]
        {
        ...
        /// one-half.  Values are stored in natural order.
        /// </summary>
        public static readonly JpegQuantizationTable K2Div2Chrominance =
