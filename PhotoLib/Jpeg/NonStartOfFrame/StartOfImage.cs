...
namespace PhotoLib.Jpeg
{
    ...
    public class StartOfImage : JpegTag
    {
        ...
        public ushort[][] ReadImageRgb()
        {
            ...
            {
                var diff = ReadDiffRfowRgb();
                var memory1 = ProcessDiffRgb(diff, pp);
                memory[line] = memory1;
            }
        ...
        public ushort[] ProcessDiffRgb(short[] diff, ushort[] pp)
        {
        ...
        public DiffBuf411[] ReadDiffRow()
        {
            int samplesPerLine = StartOfFrame.SamplesPerLine;
            var table0 = HuffmanTable.Tables[0x00];
            var table1 = HuffmanTable.Tables[0x01];

            var diff = new DiffBuf411[samplesPerLine / 4];         // 648
        ...
        public DiffBufYcc[] ReadDiffRowYcc()
        {
            int samplesPerLine = StartOfFrame.SamplesPerLine;
            var table0 = HuffmanTable.Tables[0x00];
            var table1 = HuffmanTable.Tables[0x01];

            var diff = new DiffBufYcc[samplesPerLine / 2];         // 1296
        ...
        private short ProcessColor(HuffmanTable table)
        {
